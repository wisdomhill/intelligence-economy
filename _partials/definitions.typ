...
#let horizontalrule-gap = 1em
// The gaps are additive: Typst's own block spacing is left intact and
// `horizontalrule-gap` is added above and below it. Wrapping the line in
// `align(center, ...)` would shift it, because start/end are already
// expressed as percentages of the text width.
#let horizontalrule = [
  #v(horizontalrule-gap)
